...
>
> **Already fluent in Nix?** The [Configuration](#-configuration) and [Usage](#-usage-the-icedos-command) sections are your reference. New Nix term? The [glossary](#-nix-terms-in-plain-english) explains every one in a line.
>
...
- [Usage: the `icedos` command](#-usage-the-icedos-command)
...
| `icedos configuration show modules [--enabled]` | Browse modules — enabled / available / dependencies. |
